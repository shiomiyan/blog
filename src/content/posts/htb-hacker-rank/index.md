...
とはいえステップを踏んで回答を埋めていく形式なので、案外すぐ解けてた。
...
基本、各Machineのフォーラム、[PyloadAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings)、[HackTricks](https://book.hacktricks.xyz/welcome/readme)、[たまたま見つけたチートシート](https://ed4m4s.blog/)あたりを参考に解いてた。
フォーラムは出たてほやほやのMachineだと、結構直接的なことが書かれてたりしたので「おっと...」となることがたびたびあった。
そのため、途中からあまり見なくなった。
...
Activeで初挑戦したMediumは、たぶんAmbassadorだった。
取れそうで取れないrootフラグに死ぬほど苦戦し、多分3日くらいかけて解いた。
初めてMediumのrootフラグを取ったのもこのときだった気がする。

### それ以降

出たら解くを繰り返して、Hackerランクに到達した。

しばらくは習慣的に取り組んでいたが、別のことへ興味が移ってしまった。
ここ3ヶ月くらいは、ただお布施してる人になってる。
