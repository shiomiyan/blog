...
流石に固定方法が甘く（テープで蓋の穴に固定しているだけ）、計測ノイズが酷かったと思います。製品の信頼性みたいなところはわからないですが、[固定しやすそうな熱電対も売っている](https://www.amazon.co.jp/dp/B00FVREP12)ので、これを買って鍋に固定してもいいかもしれません。

あと、この記事を書きながら、[同じようなこと](https://youtu.be/9vaDTce4eK4)をしている人を見つけました。  
[artisan](https://artisan-scope.org/)という焙煎専用のオープンソース可視化ツールがあるみたいなので、そっちを使うでも良かったかもしれません（ただし、対応しているロガーに制限があるっぽい）。
